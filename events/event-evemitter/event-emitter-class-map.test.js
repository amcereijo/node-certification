...
const EventEmiter = require('./event-emitter-class-map');
...
describe('event-emiter', () => {
  describe('addListener', () => {
    ...
    it('should have one element added for event', () => {
      expect(eventEmiter.listeners.get(event)).to.have.lengthOf(1);
    });
  });
  ...
  describe('on', () => {
    ...
    it('should have two element added for event', () => {
      expect(eventEmiter.listeners.get(event)).to.have.lengthOf(2);
    });

    it('should have one element added for an event', () => {
      expect(eventEmiter.listeners.get(event2)).to.have.lengthOf(1);
    });
  });
  ...
  describe('removeListener', () => {
    ...
    it('should have one element added for event and when remove should have 0', () => {
      ...
      expect(eventEmiter.listeners.get(event)).to.have.lengthOf(0);
    });
  });
  ...
  describe('rawListeners', () => {
    ...
    it('should return all the listeners', () => {
      expect(eventEmiter.rawListeners(event)).to.eql(eventEmiter.listeners.get(event));
      expect(eventEmiter.rawListeners(event2)).to.eql(eventEmiter.listeners.get(event2));
    });
  });
});
